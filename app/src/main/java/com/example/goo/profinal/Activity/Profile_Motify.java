...
public class Profile_Motify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_nick.setText(intent.getStringExtra("nick"));
        ...
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (edit_id.getText().toString().equals("")) {
                    ...
                    Toast.makeText(Profile_Motify.this, "아이디를 입력하세요.", Toast.LENGTH_SHORT).show();
                } else if (edit_nick.getText().toString().isEmpty()) {
                    edit_nick.requestFocus();
                    Toast.makeText(Profile_Motify.this, "닉네임을 입력하세요.", Toast.LENGTH_SHORT).show();
                } else if (edit_password.getText().toString().equals("")) {
                    edit_password.requestFocus();
                    Toast.makeText(Profile_Motify.this, "비밀번호를 입력하세요.", Toast.LENGTH_SHORT).show();
                } else if (edit_passwordCheck.getText().toString().equals("")) {
                    edit_passwordCheck.requestFocus();
                    Toast.makeText(Profile_Motify.this, "확인 비밀번호를 입력하세요.", Toast.LENGTH_SHORT).show();
                } else if (!edit_password.getText().toString().equals(edit_passwordCheck.getText().toString())) {
                    edit_passwordCheck.requestFocus();
                    Toast.makeText(Profile_Motify.this, "비밀번호가 맞지 않습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    String profile_image = uri.toString();
                    ...
                    Toast.makeText(Profile_Motify.this, "프로필 수정이 완료되었습니다", Toast.LENGTH_SHORT).show();
