...
public class Profile_Follower_Activity extends AppCompatActivity {
    ListView list;
...
//        loadData2();
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Profile_Follower_Activity.this, RealHome.class);
        ...
        btn_friend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Profile_Follower_Activity.this, Member.class);
        ...
        btn_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Profile_Follower_Activity.this, Profile_Activity.class);
        ...
        btn_chat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Profile_Follower_Activity.this, Chatting_list.class);
    ...
    private void loadData() {
        ...
        final SharedPreferences sp = getSharedPreferences(txt_id.getText().toString()+"follower11", MODE_PRIVATE);
        Gson gson = new Gson();
